...
%     'LG1-1', 'LN12', 'LN203', 'LN3-2-15X', 'LN30', 'LN3-3-10', 'LN302H', 'LN33', 'LG202', 'LN2-33-H7', 'LN2-4-6', 'LN2-5-14', 'LN206'});

init_ids = bsGetIdsFromWelllogs(wellLogs, {
  'LN203', 'LN30', 'LN3-3-10', 'LG202', 'LN2-33-H7', 'LN2-4-6', 'LN2-5-14', 'LN206'});

% 'LG1-1', 'LG1-2CH',  'LN41', 'LN3_3_17H', 'LN18'
...
% 
    struct(...
        'name', '字典反演', ...
        'flag', 'CSR', ...
        'regParam', struct('lambda', [0.7], 'gamma', [0.1 0.4]), ...
        'parampkgs', bsSetFields(GCSRSparseParam, {'sparsity', 2}), ...
        'options', bsSetFields(GInvParam.seisInvOptions, {'maxIter', 5; 'innerIter', 20; 'initRegParam', [0.7]}), ...
        'showFiltCoef', 1, ...
        'isSaveMat', 1, ...
        'isSaveSegy', 1, ...
        'load', struct(...
