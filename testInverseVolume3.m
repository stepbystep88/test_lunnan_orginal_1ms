...
% inverse a profile
[~, ~, GInvParam, data] = bsBuildInitModel(GInvParam, timeLine, ...
    wellLogs(init_ids), ...
    'title', '20200323-1ms-radon-volume-one-well', ...
...
methods = {
    ...
    struct(...
        'name', '20200323-one-well-CSR-MATLAB_model-1ms-radon', ...
        'flag', 'CSR', ...
        'regParam', struct('lambda', [0.5 1.4], 'gamma', [0.1 0.4]), ...
        'parampkgs', bsSetFields(GCSRSparseParam, {'sparsity', 1}), ...
        'options', bsSetFields(GInvParam.seisInvOptions, {'maxIter', 5; 'innerIter', 10; 'initRegParam', [0.5 1.4]}), ...
        'showFiltCoef', 1, ...
        'isSaveMat', 1, ...
        'isSaveSegy', 0, ...
        'load', struct(...
    ...
    struct(...
        'name', '20200323-one-well-LFC-MATLAB_model-1ms-radon', ...
        'flag', 'LFC', ...
        'regParam', 1.5, ...
